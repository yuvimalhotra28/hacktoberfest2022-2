...
// This is logic of Kosaraju Algorithm, Call the Kosaraju function with parameters - (total vertices, adjacency list).
// It returns the total number of strongly connected components.
