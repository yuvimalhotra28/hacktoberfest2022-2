...
public class HeapSort {
	// A function to create Max-Heap.....Takes O(nlogn) time at maximum for
	// creation...
	...
	public void heapSort(int heap[], int heapSize) {
		while (heapSize != 0) {
			// extract the root of the max heap... and append to end of heap(as this element
			// is not part of heap now)
			int root = heap[0];
